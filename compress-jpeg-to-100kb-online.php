...
<div class="container">
	...
	<div class='row' style='border: 1px solid #CCC; margin: 20px; padding: 10px; box-shadow: 2px 2px 0px 0px #CCC; border-radius: 10px; overflow: hidden;'>	
	...
	<div class="row">
		...
		<h2 class='display-6' style='text-align: center;'>How to convert PNG to JPG</h2>
		<p>
			<ol>
